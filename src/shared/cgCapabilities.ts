...
export const CG_CAPABILITIES = {
  ...
  actions: ['move', 'airborne', 'face', 'animate', 'visibility', 'effect', 'attach', 'detach', 'handoff', 'sit', 'dialogue', 'hold'],
  performance: { documentVersions: [1, 2], timingOwner: 'behavior', navigation: 'terrain-and-named-box-supports', airborne: 'anchored-cinematic-arc', propInteraction: 'deterministic-owner-socket-transfer', routes: ['required', 'preferred'], seat: 'static-box-seat-with-explicit-contact-profile', dialogue: 'staging-only-no-speech-or-lip-sync', coverageStage: 'after-performance-validation' },
  effects: ['spark'],
  ...
  unsupported: ['ik-contact', 'lip-sync', 'generic-vfx'],
