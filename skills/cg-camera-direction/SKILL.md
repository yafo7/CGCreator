...
- Select only supported movements: static, dolly, tracking, orbit, or crane. Crane is reserved for a deliberate wide-frame vertical reveal; it keeps semantic aim while the compiler solves a smooth vertical rise. Framing is wide, medium, close-up, or over-shoulder. More complex moves still require an explicit capability extension or unsupported diagnostic.
